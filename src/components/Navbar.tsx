      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <a href="/" className="flex items-center gap-3.5 group select-none">
            ...
            <div className="hidden sm:flex items-center border-l border-white/10 pl-3.5 h-6 w-[315px] flex-shrink-0">
              <span
                className="text-[15px] font-bold tracking-[0.05em] text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/70 animate-typewriter"
                style={{
